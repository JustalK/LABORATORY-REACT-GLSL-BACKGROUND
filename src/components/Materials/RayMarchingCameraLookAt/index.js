...
const RayMarchingCameraLookAtMaterial = shaderMaterial(
  {
    iTime: 0.0,
  ...
  `
    ...
    Surface sdScene(vec3 p) {
      ...
      co = minWithColor(co, sdBox(p, vec3(1), vec3(4, 0.5, -4), vec3(0, 0.55, 2), identity()));
      return co;
    }
...
extend({ RayMarchingCameraLookAtMaterial })
